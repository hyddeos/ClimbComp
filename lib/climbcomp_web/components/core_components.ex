defmodule ClimbcompWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ClimbcompWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ClimbcompWeb.Gettext, "errors", msg, opts)
    end
  end
